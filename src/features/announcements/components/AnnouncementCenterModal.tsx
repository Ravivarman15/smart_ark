                      ...
                      >
                        ...
                        <div className="flex items-center flex-wrap gap-3 text-[11px] text-muted-foreground pt-1">
                          {item.timetable_data?.rows && item.timetable_data.rows.length > 0 && (
                            <span className="flex items-center gap-1 text-primary font-semibold bg-primary/10 px-2 py-0.5 rounded">
                              <Calendar className="w-3 h-3" />
                              <span>Timetable ({item.timetable_data.rows.length})</span>
                            </span>
                          )}
                          {hasDocs && (
