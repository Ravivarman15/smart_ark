...
const REALTIME_CHANNELS: RealtimeChannel[] = [
  ...
  },
  {
    ...
    publicationMigration: "20260613_attendance_governance",
    purpose:
      "Live attendance marking, work-hours, governance (locks/closing/approvals), automation alerts + audit center",
  },
  {
    name: "fees-sync",
    tables: [
...
const PROBES: ProbeSpec[] = [
  ...
  { module: "Attendance", table: "staff_attendance",       column: "worked_minutes", migration: "20260612_attendance_module" },
  { module: "Attendance", table: "staff_attendance_audit", migration: "20260612_attendance_module" },
  { module: "Attendance", table: "attendance_settings",    migration: "20260612_attendance_module" },
  { module: "Attendance", table: "attendance_locks",       migration: "20260613_attendance_governance" },
  { module: "Attendance", table: "attendance_closings",    migration: "20260613_attendance_governance" },
  { module: "Attendance", table: "attendance_approvals",   migration: "20260613_attendance_governance" },
  { module: "Attendance", table: "attendance_alerts",      migration: "20260613_attendance_governance" },
  { module: "Attendance", table: "attendance_automation_runs",   migration: "20260613_attendance_governance" },
  { module: "Attendance", table: "attendance_governance_audit",  migration: "20260613_attendance_governance" },
