  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="hidden md:flex shrink-0">
        <CoordinatorSidebar collapsed={collapsed} onToggle={() => setCollapsed(!collapsed)} />
      </div>
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 z-50">
          ...
          <div className="relative w-64 h-full overflow-hidden">
            <CoordinatorSidebar collapsed={false} onToggle={() => setMobileOpen(false)} onNavigate={() => setMobileOpen(false)} />
