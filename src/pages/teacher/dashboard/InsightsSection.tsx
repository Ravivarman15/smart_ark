...
// The dashboard only mounts this once at least one student has been assessed,
// so there is no empty state to render here.
...
const InsightsSection: React.FC<Props> = ({ ws }) => {
  ...
  return (
    <section id="insights" className="scroll-mt-24 space-y-3">
        ...
        <div className="h-2 rounded-full bg-muted overflow-hidden">
          <div
            className={`h-full rounded-full transition-all duration-500 ${
              classAverage === null ? "bg-muted" : scoreTone(classAverage).bar
            }`}
      ...
      {/* Coverage gap — students who have never been assessed */}
      {unassessed.length > 0 && (
